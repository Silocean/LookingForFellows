...
import com.hblg.lookingfellow.qr.view.ViewfinderView;

public class CaptureActivity extends Activity implements Callback {
	 private Button scannerBack;
		...
		private void initBack(){
			scannerBack=(Button)findViewById(R.id.scane_goback_button);
		...
		protected void onPause() {
			...
			if (isBack) {
 				isBack = false;
 				//AnimUtils.scaleOut(MyCaptureActivity.this);
 			}
		}
