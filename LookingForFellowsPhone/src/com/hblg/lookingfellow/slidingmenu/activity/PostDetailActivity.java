...
public class PostDetailActivity extends Activity implements OnClickListener {
	...
	public void rely(String content) throws Exception {
		...
		String path = "http://192.168.1.152:8080/lookingfellowWeb0.2/ReplyServlet";
	...
	public ArrayList<Map<String, Object>> getData(int page) {
		...
		temp.add(louzhu);
		try {
			String path = "http://192.168.1.152:8080/lookingfellowWeb0.2/ReplyServlet?postId=" + post.getId() + "&page=" + page;
			HttpURLConnection conn = (HttpURLConnection) new URL(path).openConnection();
