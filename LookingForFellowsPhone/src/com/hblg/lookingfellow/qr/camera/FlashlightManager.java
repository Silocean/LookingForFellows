...
package com.hblg.lookingfellow.qr.camera;
...
public final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      ...
      System.out.println("This device does supports control of a flashlight");
    } else {
      Log.v(TAG, "This device does not support control of a flashlight");
      System.out.println("This device does not support control of a flashlight");
    }
  }
